...
漏判的视角数：534
无效(多判)的视角数：1664
准确率是：71.77871792513567%
召回率是：96.69206467199405%
F1是：82.3933067644963%
训练完成共用时548.9253733158112
共用时647.0173001289368

训练完成共用时1879.847505569458
共用时2034.1317746639252
'''